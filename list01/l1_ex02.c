    ...
    if(value_x == (int)value_x && value_y == (int)value_y && value_z == (int)value_z){
        ...
        if(value_x == (int)value_x && value_y == (int)value_y && value_z == (int)value_z){
            ...
            if((total - soma) >= 2){ //investe
                ...
                //deu 1, tem 2, precisa de 5
                if((total - soma) >= 5) printf("Ela conseguiu! Rebeka voltou para casa e apanhou da mae por sumir noite passada!\n");
                else printf("E parece que Rebeka vai ter que voltar andando...\n");
            }
        ...
        if(total - acum == 1){
            ...
            if(value_x == (int)value_x && value_y == (int)value_y && value_z == (int)value_z){
                ...
                if((total - soma) >= 3){ //investe
                    ...
                    //deu 2, tem 1, precisa de 7, ou seja, no mínimo 6
                    if((total - soma) >= 6) printf("Ela conseguiu! Rebeka voltou para casa e apanhou da mae por sumir noite passada!\n");
                    else printf("E parece que Rebeka vai ter que voltar andando...\n");
                }
        ...
        if(total - acum == 1){
            ...
            if(value_x == (int)value_x && value_y == (int)value_y && value_z == (int)value_z){//divisão se ajeita adicionando 3
                ...
                if((total - soma) >= 4){ //ela adiciona por vale pra ela
                    ...
                    //deu o total
                    if((total - soma) >= 7) printf("Ela conseguiu! Rebeka voltou para casa e apanhou da mae por sumir noite passada!\n");
                    //ainda assim não deu o total
                    else printf("E parece que Rebeka vai ter que voltar andando...\n");

                }//ela não adiciona porque não vale
                else printf("E parece que Rebeka vai ter que voltar andando...\n"); 
            }
